...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'app/templates')], # add the templates directory to the TEMPLATES setting
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
AUTH_USER_MODEL = 'app.CustomUser' # add the custom user model to the settings
